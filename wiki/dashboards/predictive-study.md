...
> `brain/predictive_study.py`。母集団 N=63（dead 44 / tracked 19＝**pendingでまだ死にうる=death率は下限**）。
> baseline 死亡率 70%。各因子はこれとの比較で読む。★現mcap近似・N小cell留意・同一launchpad/近時間で独立性限定。
...
- **最悪の gate×traction**: graduated × tr無＝死35/35 (100%)＝最強のavoid。
