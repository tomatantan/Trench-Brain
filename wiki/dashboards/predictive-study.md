...
> `brain/predictive_study.py`。母集団 N=99（dead 46 / tracked 53＝**pendingでまだ死にうる=death率は下限**）。
> baseline 死亡率 46%。各因子はこれとの比較で読む。★現mcap近似・N小cell留意・同一launchpad/近時間で独立性限定。

## 死の深さ: dead銘柄の平均drawdown **-47.8%**（peak比）＝死は「フェード」でなく「崩落」
...
| 因子 | 死亡率 |
|---|---|
| graduated × tr無 | 40/57 (70%) |
| KOL言及 × tr有 | 3/17 (18%) |
| mcap勢い門 × tr無 | 3/23 (13%) |
| user_checked × tr無 | 0/2 (0%) |
...
- **最悪の gate×traction**: graduated × tr無＝死40/57 (70%)＝最強のavoid。
- **最良の gate×traction**: mcap勢い門 × tr無＝死3/23 (13%)＝相対的に生存（[[manipulation-playbook]]で偽traction除外が前提）。
