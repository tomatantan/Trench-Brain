...
# $ALBEMARLE（Albemarle City）

## ライフサイクル(auto-track)
| 項目 | 値 |
|---|---|
| mint | FMTG5DSNYSS6Wv6d6bWG8MnK9ncdgVnkUFRj3ksdpump |
| pool | 9q2C9bkiNFkx7rvynPw2Yk53ufCKgSHbYkAPmqM1p9TK |
| gate | safety:ok / traction:graduated |
| mcap(birth観測) | $851,407（traction candidates 検知、2026-07-02） |
| mcap(auto-track合成時) | $1,775,925（2026-07-01T16:55:58Z） |
| peak_mcap | $1,953,524（暫定） |
| real_sol | 0 |
| reply_count | 0 |
| twitter | https://x.com/Albemarle_City |
| website | なし |
...
## 関連
- [[launchpad-economics]] — traction0 × $1.78M 境界域
- [[rug-anatomy]] — IP/brand 即死パターン
