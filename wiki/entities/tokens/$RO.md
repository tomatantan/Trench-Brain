...
> `brain/track.py` が観測→篩通過で TRACKED 登録（auto-synthesis）。mint `8krsxH…pump`。
...
- **観測**: Pump.fun bonding curve 完了→Raydium 移行（graduated）＝[[launchpad-economics]] の 1.5%側。ただし mcap $5.7k は graduation 最低水準＝「辛うじて卒業した」。
- **「Ro The Robber」**: 子供向け YouTube キャラクター由来の命名と推定→[[external-event-to-token-pattern]] の文化ミーム型。Elmo/Cocomelon 系の教育コンテンツ IP に乗る典型パターン。
