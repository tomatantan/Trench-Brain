...
## よく言及するトークン
[[$BTC]](6) [[$HYPE]](5) [[$SPCX]](2) [[$PENGU]](2) [[$ETH]](2) [[$BP]](2) [[$SOL]](2) [[$VERONA]](1) [[$JPYSC]](1) [[$SIREN]](1)

## 高エンゲージ投稿
| likes | tickers | 抜粋 | source |
|---|---|---|---|
| 1,820 |  | BULLISH: Bitcoin is now at $67,000. | [[coingecko__2066549642360152356]] |
| 1,753 |  | JUST IN: Ethereum reclaims $1,800. | [[coingecko__2066516300088693221]] |
...
- **役割**: **価格情報アグリゲータ（組織）**。投稿は「BTC が $66,000 を回復」「$SPCX が17.8%下落」等の**価格速報/データ配信**が中心＝一次の意見でなく市場状況の broadcaster。CoinMarketCap と同型の価格メディア。
- **trenchでの絡み**: 個別 trench 動線への参加でなく**事実トラッカー**として引用される。[[spacex-ipo-narrative]] では「$SPCX が上場来の全騰幅を消去」を**確定づけるデータ点**として参照＝Hayes の弱気 thesis が部分実現したことの中立的裏取り。価格の客観記録という形で各 concept の時系列を支える。
- **⚠️**: 速報ヘッドラインは「BULLISH/JUST IN」等で煽り気味の演出あり。データソースとしては中立だが見出しのトーンは割引く。
