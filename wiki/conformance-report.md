...
| C4 | 指針4 | 1ソース取込→複数ページに波及(synthesis) | ✅PASS | 波及指示あり・summary3+entity212枚 |
| C5 | 指針5 | 矛盾は消さず⚠️両論で保持する | ✅PASS | concept内 ⚠️/矛盾 68箇所・prompt指示あり |
| C6 | 指針6 | entityで観測(事実)と推論(判断)を分離する | ✅PASS | 観測/判断を分離した entity 97/212枚 |
...
| L2 | §Lint実挙動 | lintが実際に動いてる(stampが新しい＝存在でなく実行) | ✅PASS | last_lint 16h前(実行痕) |
...
| R3c | 指針6 矛盾 | base_rateのdiedと死亡台帳が矛盾してない(計測整合) | ✅PASS | died=10 / 死亡台帳10件(差≤2=整合) |
