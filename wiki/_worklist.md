...
|---|---|---|---|
| [[$ETH]] | 102 | 12 | 7875♥ @CryptoHayes: $ETH to $5k before $SOL to $300. Who is with me? / 5873♥ @zhusu: For this leg of the supercycle I'm not bothering t |
| [[$BTC]] | 98 | 12 | 13315♥ @milesdeutscher: $BTC in March: $71k Coinbase app store ranking: 20 / 10391♥ @zhusu: I'm only going to make one prediction for 2022 and |
| [[$MASK]] | 37 | 1 | 795♥ @spyzer: Never Underestimate The Power of Community    $MAS / 689♥ @spyzer: $MASK UUUUUUUUUUUUUP 🔥🔥🔥  |
| [[$SOL]] | 33 | 8 | 7875♥ @CryptoHayes: $ETH to $5k before $SOL to $300. Who is with me? / 7585♥ @milesdeutscher: Many of next cycle's top performers haven't been r |
| [[$USDC]] | 25 | 4 | 4455♥ @lookonchain: A wallet named Ansem(@blknoiz06) sold 194,799 $TRU / 3764♥ @lookonchain: Arthur Hayes(@CryptoHayes) sold 2,373 $ETH($8.32M) |
...
| [[$TRUMP]] | 10 | 6 | 7756♥ @blknoiz06: 77 million people voted for trump  $TRUMP coin doe / 5089♥ @milesdeutscher: The $TRUMP launch is the craziest thing I've seen  |
| [[$PUMP]] | 9 | 3 | 4751♥ @a1lon9: today we announce $PUMP  pump fun invented a compl / 3944♥ @a1lon9: the ticker is $PUMP |
| [[$DOGE]] | 8 | 5 | 4726♥ @milesdeutscher: AI will be one of the biggest bubbles in financial / 1518♥ @lookonchain: On Apr 4, @elonmusk changed the Bluebird to dog, t |
...
| [[$PUMPI]] | 8 | 1 | 66♥ @pumpilians_: New players can now understand the game much easie / 53♥ @pumpilians_: Clan system is now live!  - Create a clan for 500, |

## 2) concept 候補（閾値超え・まだconcept未登場）
下記は複数アカが言及し始めたのにconceptが無い＝emerge候補。動線/型が立つか判断し、立つなら concept を新規/更新。

- [[$ETH]]（102件/12アカ）まだconcept無し → 動線/型を検討
- [[$BTC]]（98件/12アカ）まだconcept無し → 動線/型を検討
- [[$SOL]]（33件/8アカ）まだconcept無し → 動線/型を検討
- [[$USDC]]（25件/4アカ）まだconcept無し → 動線/型を検討
- [[$PEPE]]（18件/5アカ）まだconcept無し → 動線/型を検討
- [[$BONK]]（16件/3アカ）まだconcept無し → 動線/型を検討
- [[$HYPE]]（15件/9アカ）まだconcept無し → 動線/型を検討
- [[$KINTON]]（13件/2アカ）まだconcept無し → 動線/型を検討
- [[$YAJUCOIN]]（12件/4アカ）まだconcept無し → 動線/型を検討
- [[$WOJAK]]（11件/5アカ）まだconcept無し → 動線/型を検討
- [[$TRUMP]]（10件/6アカ）まだconcept無し → 動線/型を検討
- [[$PUMP]]（9件/3アカ）まだconcept無し → 動線/型を検討
- [[$DOGE]]（8件/5アカ）まだconcept無し → 動線/型を検討
- [[$WIF]]（8件/5アカ）まだconcept無し → 動線/型を検討
- [[$JOTCHUA]]（8件/2アカ）まだconcept無し → 動線/型を検討
- [[$ARB]]（7件/3アカ）まだconcept無し → 動線/型を検討
- [[$MERLIN]]（7件/2アカ）まだconcept無し → 動線/型を検討
- [[$KINS]]（7件/3アカ）まだconcept無し → 動線/型を検討
- [[$STRC]]（7件/4アカ）まだconcept無し → 動線/型を検討
- [[$USDT]]（7件/3アカ）まだconcept無し → 動線/型を検討
- [[$ZEC]]（6件/4アカ）まだconcept無し → 動線/型を検討
- [[$XRP]]（6件/2アカ）まだconcept無し → 動線/型を検討
- [[$PENGU]]（6件/3アカ）まだconcept無し → 動線/型を検討
- [[$SHIB]]（6件/2アカ）まだconcept無し → 動線/型を検討
- [[$FARTCOIN]]（5件/3アカ）まだconcept無し → 動線/型を検討
- [[$LIBRA]]（5件/2アカ）まだconcept無し → 動線/型を検討
...
- [[$WBTC]]（3件/2アカ）まだconcept無し → 動線/型を検討
- [[$BP]]（3件/3アカ）まだconcept無し → 動線/型を検討
