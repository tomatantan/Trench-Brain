...
前回ingest以降の新シグナルツイ **8299件**（基準時刻 2026-07-02T10:16Z）。手順は brain/INGEST.md。
★**鮮度ゲート適用済**: 合成対象は下記 §1a（直近48h×複数アカで生きてる物）だけ。
§1b は単一アカ連投＝要警戒。stale（48h言及ゼロ＝冷えた）**362ティッカーは降格**して非表示。
...
|---|---|---|---|---|
| [[$BTC]] | 11 | 6 | 62 | 506♥ @CredibleCrypto: Unfortunately nearly fully retraced our move on $X / 503♥ @CredibleCrypto: Unfortunately nearly fully retraced our move on $X |
| [[$ETH]] | 11 | 3 | 80 | 3864♥ @zhusu: mental math with $eth will be a lot easier when it / 1758♥ @lookonchain: The #Ethereum Foundation sold another 100 $ETH($30 |
