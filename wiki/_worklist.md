...
前回ingest以降の新シグナルツイ **4615件**（基準時刻 2026-06-23T00:39Z）。手順は brain/INGEST.md。
...
| [[$ETH]] | 11 | 5 | 85 | 4097♥ @CryptoHayes: 1/ Guess who is pumping $BTC and $ETH  / 3864♥ @zhusu: mental math with $eth will be a lot easier when it |
...
| [[$USDC]] | 4 | 1 | 18 | 3000♥ @lookonchain: Trump's World Liberty(@worldlibertyfi) just spent  / 2801♥ @lookonchain: North Korean hackers went long $ETH on #Hyperliqui |
...
| [[$SPCX]] | 1 | 1 | 5 | 107♥ @coinkeiba: $SPCX 買わずに淡々と $TSLA 集めてる🚘 / 25♥ @MurphyBTC: $SPCX #株   買い増し前に確認したい「ロックアップ解除リスク」 低フロート相場の次に来る“売 |
