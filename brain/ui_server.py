...
def _judge_unknown(die_pct):
    return {"verdict": "UNKNOWN", "headline": f"未観測。base-rate: 門通過でも死{die_pct}%",
            "lens": {"hook": "生まれたて＝まだ誰にも分からない。だから“最初に何を見るか”を持っておく",
                     "why": f"観測履歴ゼロ＝この銘柄の材料は何も無い。魔界は門を通った銘柄でも{die_pct}%が死ぬ＝生まれたてに焦って飛び乗るのが一番負ける。",
                     "how": "1) 最初に誰が拾うか＝実績あるKOLが来るまで待つ\n2) DexScreenerで買い（緑）が本物か・保有者が分散してるか\n3) 作った人が過去に連続でrug（持ち逃げ）してないか",
                     "act": "今は待つ。上の“最初のKOL”が来たら初めて判断に入る"},
